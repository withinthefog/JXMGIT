 ...
 * 
 */
package nc.ui.mallpos.vipcardgrade;
 ...
 *
 */
public class MPOS_VipcardgradeUI extends BillManageUI {
	 ...
	 * @param fp
	 */
	public MPOS_VipcardgradeUI(FramePanel fp) {
		super(fp);
		initData();
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param useBillSource
	 */
	public MPOS_VipcardgradeUI(Boolean useBillSource) {
		super(useBillSource);
		initData();
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param arg4
	 */
	public MPOS_VipcardgradeUI(String arg0, String arg1, String arg2, String arg3,
			String arg4) {
	...
	private void initData(){
		...
		try{
			uiBuffer.clear();
			MPOS_VipcardgradeVO[] vos = (MPOS_VipcardgradeVO[])service.queryByCondition(MPOS_VipcardgradeVO.class, " isnull(dr,0)=0 ");
	...
	protected AbstractManageController createController() {
		...
		return new MPOS_VipcardgradeCTL();
	}
	...
	protected ManageEventHandler createEventHandler() {
		// TODO Auto-generated method stub
		return new MPOS_VipcardgradeHDL(this, this.getUIControl());
	}
